...
export class UserController {
  ...
  async updateUser(
    ...
    return await this.userService.updateUser(data, param.user);
  }
  ...
  async findMotoboys(@User() user: UserRequest) {
    ...
    return await this.userService.findMotoboys(user.type, user.id);
  }
  ...
  async findUserByUsername(
    ...
    return await this.userService.findUserByUsername(param.user);
  }
  ...
  async updateUserNotification(
    ...
    return await this.userService.updateUserNotification(data, param.user);
  }
  ...
  async resetUserPassword(
    ...
    return await this.userService.resetUserPassword(param.user);
  }
